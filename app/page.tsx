      ...
      <section className="relative h-screen flex flex-col items-center justify-center text-center px-4">
        <motion.div style={{ opacity, scale, y }} className="max-w-4xl mx-auto">
          ...
          >
            ...
            <span className="text-neutral-400">thoughtful</span> design.
          </motion.h1>
          <motion.p
          ...
          >
            We craft digital experiences for health, wellness, and fashion
            brands that connect, convert, and captivate.
          </motion.p>
          <motion.div
            initial={{ opacity: 0, y: 20 }}
            animate={{ opacity: 1, y: 0 }}
          ...
          >
            <Button
              variant="outline"
              size="lg"
              className="rounded-full border-neutral-700 text-gray-700 hover:bg-white hover:text-black transition-all duration-300"
            >
              View our work
            ...
            <div className="grid grid-cols-1 md:grid-cols-2 gap-16 items-center">
              ...
              >
                <h3 className="text-2xl md:text-3xl font-light mb-6">
                  Minimalist. Functional. Impactful.
                </h3>
                <p className="text-neutral-400 mb-6">
                  We believe in the power of simplicity. Our design philosophy
                  strips away the unnecessary to focus on what truly matters:
                  your brand's message and the user experience.
                </p>
                <p className="text-neutral-400 mb-6">
                  Every pixel, interaction, and line of code serves a purpose.
                  We craft digital experiences that not only look beautiful but
                  drive real business results.
                </p>
                <Button
                  variant="link"
                  className="text--gray-700 p-0 hover:text-neutral-400 transition-colors"
                >
